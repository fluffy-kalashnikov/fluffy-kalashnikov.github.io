...
{{< fakegif "trash_mountain_base_props_collision.webm" >}}
...
{{< fakegif "trash_mountain_input_output.webm" >}}
...
{{< fakegif "jetty_small_input_output.webm" >}}

It also attaches to chosen nearby sufaces for more vertical platforms.

{{< fakegif "jetty_large_input_output.webm" >}}
